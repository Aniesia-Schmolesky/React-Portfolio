...
import geekEmporium from './images/geek-emporium.PNG'
import inspirationStation from './images/inspiration-station.png'
import jsQuiz from './images/js-quiz.png'
import passwordGenerator from './images/password-generator.png'
import teamProfilePic from './images/team-profile-generator.png'
            ...
            <div class="container px-5 py-24 mx-auto">
                < div class="flex flex-wrap -m-4">
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/JoeyFitz/First-Team-Project" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/Aniesia-Schmolesky/NoSQL-Workout-Tracker" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/xBOBOYx/Project-2" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/Aniesia-Schmolesky/JS-Quiz-Homework-4" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/Aniesia-Schmolesky/Password-Generator-Homework-3" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                    ...
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     <div class="flex items-center flex-wrap ">
                    <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0" href="https://github.com/Aniesia-Schmolesky/Team-Profile-Generator" target="_blank">GitHub Link
                    </a>
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
